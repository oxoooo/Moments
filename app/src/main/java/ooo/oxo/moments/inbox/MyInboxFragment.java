...
public class MyInboxFragment extends RxFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new MyInboxAdapter(getContext());
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.inbox_mine_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        subscribe(newsApi.inbox(), envelope -> adapter.replaceWith(envelope.oldStories));
    }
